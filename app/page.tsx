    ...
    <main className="relative flex flex-col gap-3">
      ...
      <section className="relative flex flex-col gap-6 pt-3 lg:flex-row lg:px-8 lg:py-16">
        ...
        <div className="flex items-center justify-center lg:py-8 lg:basis-5/12">
          <div className="relative rounded-lg lg:flex lg:items-stretch lg:justify-center lg:shadow-black/50 lg:shadow-2xl lg:w-full">
      ...
      <section className="bg-rose-50 py-8 lg:py-0">
      ...
      <section className="lg:px-8 lg:py-12">
        <p className="font-bold text-center py-2 lg:text-2xl">Voices of Resilience</p>
        <p className="text-center">Real stories from warriors and advocates living with Sickle Cell Disease</p>
        <div className="grid grid-cols-1 grid-rows-2 px-3 py-8 gap-6 justify-items-center content-center lg:px-6 lg:py-8 lg:grid-rows-1 lg:grid-cols-3 lg:gap-6">
          {
      ...
      <section className="py-8 lg:pt-8 lg:pb-18">
      ...
      <footer className="bg-on-background text-background text-[.5em] flex gap-3 px-3 py-3 lg:px-8 lg:py-8 lg:text-[.7em]">
        ...
        <p className="text-background-container">@2025 Awareness. All righys reserved.</p>
      </footer>
    </main>
  );
}
